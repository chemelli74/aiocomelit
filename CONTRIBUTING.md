...
aiocomelit could always use more documentation, whether as part of the official aiocomelit docs, in docstrings, or even on the web in blog posts, articles, and such.
...
2. Clone your fork locally:
   ...
   ```shell
   $ git clone git@github.com:your_name_here/aiocomelit.git
   ```
...
[gh-issues]: https://github.com/chemelli74/aiocomelit/issues
